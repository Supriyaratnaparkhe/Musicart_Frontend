...
//                 isLoggedIn={isLoggedIn}
//               />
//               <MobileFooter isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} state={"home"} cartItemCount={cartItemCount}/>
//               <ToastContainer/>
//             </>
//           ) : (
//             loading && <Spinner />
...
const HomePage = () => {
  ...
  // useEffect(() => {
  //   if (!searchQueryHandled && !filters.search) {
  //     const { searchq } = location.state || {};
  //     console.log("filter value from products:", searchq);
  //     setFilters((prevFilters) => ({
  //       ...prevFilters,
  //       search: searchq || prevFilters.search, // Keep the previous search value if searchq is undefined
  //     }));
  //     setSearchQueryHandled(true); // Mark search query as handled
  //   }
  // }, [location.state, searchQueryHandled]);
  ...
  //     ...prevFilters,
  //     [name]: value,
  //     // Maintain the existing search value
  //     search: prevFilters.search !== undefined ? prevFilters.search : ''
  //   }));
  // };
